  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Card className="bg-white border-gray-200 shadow-sm">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <CardTitle className="flex items-center gap-2">
                  ...
                  <span className="text-gray-900">High-Resolution Map Viewer</span>
                </CardTitle>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <Label htmlFor="server-id" className="text-gray-700">Server ID</Label>
                <Input
                  id="server-id"
                  value={serverId}
              ...
              <Card className="bg-gray-50 border-gray-200">
                <CardContent className="pt-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-medium text-gray-800">Map Storage Info</span>
                  </div>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div>
                      <span className="text-gray-500">Total Maps:</span>
        ...
        <Card className="bg-white border-gray-200 shadow-sm">
          <CardHeader>
            <CardTitle className="text-gray-900">Map Image</CardTitle>
          </CardHeader>
          <CardContent>
            {mapLoading && (
        ...
        {servers && servers.length > 0 && (
          <Card className="bg-white border-gray-200 shadow-sm">
            <CardHeader>
              <CardTitle className="text-gray-900">Available Servers</CardTitle>
            </CardHeader>
            <CardContent>
